...
try {
 ...
 await Users.createData(stringUserID, {
  ...
  logger(`Load Data Người Dùng Mới - [ UID: ${stringUserID} | NAME: ${singleData.name} ]`, "[ DATABASE ]");
                      }
                  } catch (e) {
                      console.log(e);
                  }
 ...
 logger(`Load Data Nhóm Mới - [ TID: ${stringThreadID} | Tên Nhóm: ${setting.threadName} ]`, "[ DATABASE ]");
          }
  ...
  logger(`Load Data Người Dùng Mới - [ UID: ${stringSenderID} | NAME: ${infoUsers.name} ]`, "[ DATABASE ]");
          }
