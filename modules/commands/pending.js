...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "menu")) fs.mkdirSync(dirMaterial, {
        recursive: true
    });
    ...
    if (isNaN(body) && body.indexOf("c") == 0 || body.indexOf("cancel") == 0) {
        ...
        for (const singleIndex of index) {
            ...
            api.sendMessage("", event.threadID, () => api.sendMessage({
                body: `Hi, giờ bạn có thể dùng bot được rùi nhoaa. Nếu chưa được kích hoạt bot vui lòng liên hệ Admin nhé !`,
                attachment: fs.createReadStream(__dirname + "/trogiup/menu/trogiup.mp4")
    ...
    switch (args[0]) {
        ...
        case "User": {
            ...
            try {
                ...
                return api.sendMessage("𝙇𝙤̂̃𝙞 🚫", threadID, messageID)
            }
